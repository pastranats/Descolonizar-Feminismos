$(window).on('load', function() {
    ...
    /*=====================================================================
        Smooth scroll for CTA to portfolio
    =========================================================================*/
    ...
    // Stack button and CTA when manifesto is collapsed
    var $manifiesto = $('#manifiesto');
    var $ctaContainer = $manifiesto.closest('.container');
    $manifiesto.on('hide.bs.collapse', function(){
      $ctaContainer.addClass('stack-cta');
    });
    $manifiesto.on('show.bs.collapse', function(){
      $ctaContainer.removeClass('stack-cta');
    });
